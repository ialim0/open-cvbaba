...
interface FLAcademicTemplate3Props {
  scale?: number;
  className?: string;
  compact?: boolean;
  isModal?: boolean;
...
const FLAcademicTemplate3: React.FC<FLAcademicTemplate3Props> = ({ scale = 1, className = '', compact = false, isModal = false }) => {
      ...
      >
        ...
        <div>
          <p style={paragraphStyles}>
            I am writing to formally request a sabbatical leave for the Fall semester of the 2025-2026 academic year. Having served as a faculty member in the Department of Comparative Literature for the past seven years, I am eligible for this sabbatical under the university's faculty development policy.
          </p>
          
          <p style={paragraphStyles}>
            During my sabbatical, I plan to complete my book manuscript, "<em>Borders in Translation: Literary Migrations Across the Global South</em>," which examines how contemporary authors from Latin America, West Africa, and Southeast Asia represent cross-cultural identity formation in their works.
          </p>
          ...
          <div style={sabbaticalPlanStyles}>
            ...
            <ol style={timelineStyles}>
              <li style={timelineItemStyles}><strong>Manuscript Completion:</strong> Finalizing the remaining three chapters of my book manuscript (approximately 100 pages), which has already been solicited by Duke University Press.</li>
              <li style={timelineItemStyles}><strong>Archival Research:</strong> Conducting a four-week research visit to the National Library of Brazil in Rio de Janeiro, where I will examine previously unexplored correspondence between Brazilian modernist writers and their counterparts in Senegal and the Philippines.</li>
              <li style={timelineItemStyles}><strong>International Collaboration:</strong> Working with colleagues at the University of São Paulo on our joint digital humanities project mapping transnational literary influences, which has been preliminarily funded by a grant from the Mellon Foundation.</li>
            </ol>
            
            <p style={paragraphStyles}>This work will directly contribute to our department's strategic emphasis on global literary movements and will enhance our graduate course offerings in transnational literary studies upon my return.</p>
          </div>

          <p style={paragraphStyles}>
            I have carefully planned for my teaching and service responsibilities during my absence. Professor Anna Kim has agreed to serve as interim advisor to the three doctoral students under my supervision, and I have arranged with Professor James Wong to cover my undergraduate seminar on World Literature (CL301).
          </p>

          <p style={paragraphStyles}>
            Upon my return in Spring 2026, I will offer a new graduate seminar based on my sabbatical research, tentatively titled "Literary Border-Crossings in the Global South," which will complement our existing curriculum in transnational literary studies.
          </p>

          <p style={paragraphStyles}>
            Thank you for considering this request. I believe this sabbatical will significantly enhance my scholarly contribution to Boston University and to the field of comparative literature. I am happy to provide any additional information that might be helpful in your deliberation.
          </p>
        </div>
    ...
    >
      ...
      <div>
        ...
        <div style={sabbaticalPlanStyles}>
          ...
          <p style={paragraphStyles}>My sabbatical project will involve three interconnected components:</p>
          <ol style={timelineStyles}>
            <li style={timelineItemStyles}><strong>Manuscript Completion:</strong> Finalizing the remaining three chapters of my book manuscript (approximately 100 pages), which has already been solicited by Duke University Press. This work will synthesize my research on transnational literary movements and provide a comprehensive analysis of how contemporary authors navigate cultural boundaries in their creative works. The manuscript will include detailed case studies of authors such as Chimamanda Ngozi Adichie, Junot Díaz, and Viet Thanh Nguyen, examining how their works reflect and challenge traditional notions of cultural identity.</li>
            <li style={timelineItemStyles}><strong>Archival Research:</strong> Conducting a four-week research visit to the National Library of Brazil in Rio de Janeiro, where I will examine previously unexplored correspondence between Brazilian modernist writers and their counterparts in Senegal and the Philippines. This archival work will provide crucial primary source material for my book's central argument about cross-cultural literary influence. I have already secured access to the library's special collections and have arranged meetings with local scholars who can provide additional context for the materials.</li>
            <li style={timelineItemStyles}><strong>International Collaboration:</strong> Working with colleagues at the University of São Paulo on our joint digital humanities project mapping transnational literary influences, which has been preliminarily funded by a grant from the Mellon Foundation. This collaboration will result in a digital archive that will be accessible to scholars worldwide and will include interactive maps showing the flow of literary ideas across different regions. The project will also involve developing new methodologies for analyzing transnational literary networks using computational approaches.</li>
          </ol>
          
          <p style={paragraphStyles}>This work will directly contribute to our department's strategic emphasis on global literary movements and will enhance our graduate course offerings in transnational literary studies upon my return. The research will also strengthen our department's international reputation and provide new opportunities for student research and collaboration. Additionally, the digital humanities component will position our department at the forefront of innovative literary scholarship.</p>
        </div>
        ...
        <p style={paragraphStyles}>
          Upon my return in Spring 2026, I will offer a new graduate seminar based on my sabbatical research, tentatively titled "Literary Border-Crossings in the Global South," which will complement our existing curriculum in transnational literary studies. I also plan to organize a symposium featuring scholars from Latin America, Africa, and Asia to foster international scholarly exchange within our department. This symposium will not only showcase the research conducted during my sabbatical but will also establish ongoing collaborative relationships with international scholars.
        </p>
        
        <p style={paragraphStyles}>
          The sabbatical will also provide me with the opportunity to develop new research methodologies that I can incorporate into my teaching. Specifically, I plan to explore digital humanities approaches to literary analysis that will enhance our department's technological capabilities and provide students with cutting-edge research tools. These methodologies will be particularly valuable for our graduate students who are increasingly interested in interdisciplinary approaches to literary study.
        </p>
        
        <p style={paragraphStyles}>
          In addition to the primary research activities, I will use the sabbatical period to strengthen existing international partnerships and establish new ones. I have already received invitations to present my research at conferences in Brazil, Senegal, and the Philippines, which will provide valuable opportunities for scholarly exchange and collaboration. These presentations will also help to raise the international profile of our department and university.
        </p>
        
        <p style={paragraphStyles}>
          Thank you for considering this request. I believe this sabbatical will significantly enhance my scholarly contribution to Boston University and to the field of comparative literature. The research I conduct during this period will not only advance my own scholarly agenda but will also strengthen our department's position as a leader in transnational literary studies. The international collaborations and digital humanities initiatives will provide long-term benefits for our students and faculty. I am happy to provide any additional information that might be helpful in your deliberation.
        </p>
      </div>
...
export default FLAcademicTemplate3;